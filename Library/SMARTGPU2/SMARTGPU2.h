...
//Uncomment next line to allow SMARTGPU2 communicate via hardware serial ports, If this line is commented, then Software Serial will be used
...
//IFs
...
#else                                //Use software serial, the next defined TX_PIN and RX_PIN will be used for SmartGPU2 communication
	...
	//Software serial UART Transmit pin - Connect this pin to SmartGPU2 RX pin
	#define SG_TX_PIN     3            //----------------------------------------------------------------------------------------------
	//Software serial UART Receive pin - Connect this pin to SmartGPU2 TX pin
	#define SG_RX_PIN     2            //----------------------------------------------------------------------------------------------
#endif

//SMARTGPU2 RESET PIN DEFINITION
...
//Define for the pin of arduino that will reset SmartGPU2, this arduino pin is connected via the SmartSHIELD board(Default connected pin 4) to SmartGPU2 RESET pin
#define SG_RESET 4                   //----------------------------------------------------------------------------------------------         
...
#define SG_RESET           13       //re-define SG_RESET pin as 13 as this is the pin that is connected to Reset pin of SmartGPU2 when mounted as shield
#define SG_SERIALPORT     (Serial)  //re-define serial port to hardware serial(serial1)
#endif
