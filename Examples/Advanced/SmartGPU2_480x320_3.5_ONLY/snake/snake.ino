...
void setup() {                
  ...
  lcd.init();  
  lcd.start(); 
  lcd.baudChange(SG_BAUD4); //For fast drawing we need a big baudRate. Note: if using Software Serial, use SG_BAUD2 or less!
...
void drawScoreBoard() {
  ...
  lcd.string(0, (CELL_MAXIMUM_Y * CELL_HEIGHT) + 3, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "Level ", &nb);
  itoa(level + 1, buf, 10);
  lcd.setTextColour(GREY4);
  lcd.drawRectangle(39, (CELL_MAXIMUM_Y * CELL_HEIGHT) + 3, 50, MAX_Y_LANDSCAPE, SG_BLACK, solidFill);
  lcd.string(39, (CELL_MAXIMUM_Y * CELL_HEIGHT) + 3, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, buf, &nb);
  ...
  lcd.string(73, (CELL_MAXIMUM_Y * CELL_HEIGHT) + 3, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, buf, &nb);
...
void drawCountDown() {
  ...
  lcd.string(COUNTDOWN_LABEL_X, COUNTDOWN_LABEL_Y, MAX_X_PORTRAIT, MAX_Y_PORTRAIT, "Level", &nb);
  itoa((level + 1), buf, 10);
  lcd.string(COUNTDOWN_COUNTL_X, COUNTDOWN_LABEL_Y, MAX_X_PORTRAIT, MAX_Y_PORTRAIT, buf, &nb);
  ...
  for (byte x=3; x>=1; x--) {
    ...
    itoa(x, buf, 10);
    lcd.string(COUNTDOWN_MAIN_LEFT + 67, COUNTDOWN_TOP + 40, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, buf, &nb);
  ...
  lcd.drawRectangle(COUNTDOWN_MAIN_LEFT, COUNTDOWN_TOP, COUNTDOWN_MAIN_LEFT + COUNTDOWN_MAIN_WIDTH, COUNTDOWN_TOP + COUNTDOWN_HEIGHT, GREY3, SG_FILL);
  lcd.string(COUNTDOWN_MAIN_LEFT + 25, COUNTDOWN_TOP + 40, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "GO !", &nb);
  delay(500);
...
void drawMessage(byte icon) {
  ...
  switch (icon) {
    ...
    case BOARD_APPLE:
      ...
      lcd.string(MESSAGE_BOX_LEFT + 85, MESSAGE_BOX_TOP + 20, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "N", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 105, MESSAGE_BOX_TOP + 25, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "I", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 112, MESSAGE_BOX_TOP + 18, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "C", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 132, MESSAGE_BOX_TOP + 25, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "E", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 143, MESSAGE_BOX_TOP + 20, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, " ", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 158, MESSAGE_BOX_TOP + 20, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "W", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 178, MESSAGE_BOX_TOP + 23, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "O", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 198, MESSAGE_BOX_TOP + 18, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "R", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 216, MESSAGE_BOX_TOP + 26, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "K", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 233, MESSAGE_BOX_TOP + 22, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "!", &nb);
      lcd.setTextSize(SG_FONT2);
      lcd.setTextColour(GREY3);
      lcd.string(MESSAGE_BOX_LEFT + 85, MESSAGE_BOX_TOP + 59, MESSAGE_BOX_LEFT + MESSAGE_BOX_WIDTH - 10, MAX_Y_LANDSCAPE, "You have cleared this level .. the next level is going to be even harder!", &nb);
      break;
    ...
    case BOARD_BOMB:
      ...
      lcd.setTextColour(DARK_RED);
      lcd.string(MESSAGE_BOX_LEFT + 85, MESSAGE_BOX_TOP + 16, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "B", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 104, MESSAGE_BOX_TOP + 20, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "O", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 127, MESSAGE_BOX_TOP + 14, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "O", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 151, MESSAGE_BOX_TOP + 21, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "M", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 176, MESSAGE_BOX_TOP + 16, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "!", &nb);
      lcd.setTextSize(SG_FONT2);
      lcd.setTextColour(GREY3);
      lcd.string(MESSAGE_BOX_LEFT + 85, MESSAGE_BOX_TOP + 55, MESSAGE_BOX_LEFT + MESSAGE_BOX_WIDTH - 10, MAX_Y_LANDSCAPE, "You stepped on a bomb .. game over. Try again to see if you can do better.", &nb);
      ...
      buf[index] ='n'; index++;
      buf[index] ='.'; index++;
      lcd.string(MESSAGE_BOX_LEFT + 118, MESSAGE_BOX_TOP + 151, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, buf, &nb);
    ...
    case BOARD_WALL:
      ...
      lcd.setTextColour(DARK_RED);
      lcd.string(MESSAGE_BOX_LEFT + 85, MESSAGE_BOX_TOP + 16, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "B", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 104, MESSAGE_BOX_TOP + 20, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "A", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 127, MESSAGE_BOX_TOP + 14, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "M", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 153, MESSAGE_BOX_TOP + 19, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "!", &nb);
      lcd.setTextSize(SG_FONT2);
      lcd.setTextColour(GREY3);
      lcd.string(MESSAGE_BOX_LEFT + 85, MESSAGE_BOX_TOP + 55, MESSAGE_BOX_LEFT + MESSAGE_BOX_WIDTH - 10, MAX_Y_LANDSCAPE, "You hit the wall .. game over. Try again to see if you can do better.", &nb);
      lcd.imageJPGSD(MESSAGE_BOX_LEFT + 82, MESSAGE_BOX_TOP + 144, SG_SCALE1_2, "apple");
      itoa(fruit, buf, 10);
    ...
    case BOARD_SNAKE:
      ...
      lcd.setTextSize(SG_FONT4);
      lcd.setTextColour(DARK_RED);
      lcd.string(MESSAGE_BOX_LEFT + 85, MESSAGE_BOX_TOP + 16, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "O", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 110, MESSAGE_BOX_TOP + 20, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "U", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 131, MESSAGE_BOX_TOP + 14, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "C", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 156, MESSAGE_BOX_TOP + 19, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "H", &nb);
      lcd.string(MESSAGE_BOX_LEFT + 180, MESSAGE_BOX_TOP + 15, MAX_X_LANDSCAPE, MAX_Y_LANDSCAPE, "!", &nb);
      lcd.setTextSize(SG_FONT2);
      lcd.setTextColour(GREY3);
      lcd.string(MESSAGE_BOX_LEFT + 85, MESSAGE_BOX_TOP + 55, MESSAGE_BOX_LEFT + MESSAGE_BOX_WIDTH - 10, MAX_Y_LANDSCAPE, "You bit yourself .. game over. Try again to see if you can do better.", &nb);
      lcd.imageJPGSD(MESSAGE_BOX_LEFT + 82, MESSAGE_BOX_TOP + 144, SG_SCALE1_2, "apple");
      itoa(fruit, buf, 10);
